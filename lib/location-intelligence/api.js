...
const { LocationInsightPersistedSchema } = require('../schemas/location-insight')
const {
...
const ADDRESS_NOT_FOUND_ERROR = 'Endereço não encontrado. Verifique o endereço, bairro ou cidade informados.'

async function resolveStandaloneLocationInsight(input, options = {}) {
