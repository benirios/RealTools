...
import { Building2, Handshake, MapPinned, Search, Target, UserRoundSearch } from 'lucide-react'
...
export function SidebarNav() {
  ...
  return (
    <nav className="flex-1 space-y-0.5 overflow-y-auto px-2 py-2">
      ...
      <NavItem href="/negocios" label="Negócios" icon={Handshake} isActive={pathname.startsWith('/negocios')} />
